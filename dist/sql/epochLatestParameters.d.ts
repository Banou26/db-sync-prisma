...
/**
 */
export const epochLatestParameters: () => $runtime.TypedSql<epochLatestParameters.Parameters, epochLatestParameters.Result>

export namespace epochLatestParameters {
